...
let circle = document.querySelector(".circleUp");
let maxSize = 250;
let minSize = 150;
let currentSize = 150;
let texts = ["Riesgo Bajo", "Riesgo Medio", "Riesgo Alto", "Low Risk", "Medium Risk", "High Risk"];


function changeSizeAndText(lang) {
    currentSize += 50;
    ...
    // Determine el índice del texto según el tamaño actual
    let index;
    if (currentSize === minSize) {
        ...
        index = 1; // Riesgo medio
    }

    circle.textContent = texts[index+lang];
}
